...
INSERT INTO mainland VALUES (2,'Австралія та океанія',8520000,32600000);
INSERT INTO mainland VALUES (3,'Північна америка',24710000,579000000);
INSERT INTO mainland VALUES (4,'Південна америка',17840000,422500000);
INSERT INTO mainland VALUES (5,'Африка',30370000,1216000000);
INSERT INTO mainland VALUES (6,'Антарктида',14000000,0);
select*from mainland;
...
UPDATE time_zone SET Time = '2:00' WHERE (id_zone = '17'); 
...
INSERT INTO country VALUES (2,'ОАЕ',83600,'1971-12-02','Respublica','Дирхам','Насір ель Ахлі','Саїд Джара',9400000,1,5,'+971');
INSERT INTO country VALUES (2,'Росія',17100000,'1990-6-12','Monarhiya','Рубль','Володимир Путін','Дмитро Медведєв',144500000,2,8,'+7');
INSERT INTO country VALUES (3,'Велика британія',242495,'1922-03-12','Monarhiya','Фунт стерлінгів','Єлизавета II','Тереза Мей',66020000,3,2,'+44');
INSERT INTO country VALUES (4,'Україна',603628,'1991-8-21','Monarhiya','Гривня','Володимир Зеленський','Гройсман',44830000,4,4,'+380');
INSERT INTO country VALUES (5,'Польща',312679,'1918-11-11','Respublica','Злотий','Аджей Дуда','Роберт Левандовські',37970000,5,4,'+48');
INSERT INTO country VALUES (6,'США',9826675,'1776-7-4','Respublica','Американський долар','Дональд Трамп','Майк Пенс',325719178,6,16,'+1');
INSERT INTO country VALUES (7,'Австралія',7686850,'1901-1-1','Respublica','Австралійський долар','Єлизавета II','Скотт Моррісон',21507717,7,19,'+61');
INSERT INTO country VALUES (8,'Південно-Африка́нська Респу́бліка',1221037,'1961-5-6','Monarhiya','Ранд','Матамела Сиріл Рамафоса',NULL,50586757,8,15,'+27');
INSERT INTO country VALUES (9,'Єгипет',1001450,'1922-2-28','Monarhiya','Єгипетський фунт','Абдель Фаттах Ас-Сісі',NULL,92658900,9,16,'+20');
INSERT INTO country VALUES (10,'Китай',9597000,' 1949-03-1','Monarhiya','Юань Женьміньбі','Сі Цзіньпін',NULL,1386000000,10,9,'+61');
INSERT INTO country VALUES (11,'Японія',377972,'1947-5-3','Monarhiya','Єна','Його величність Акіхіто',NULL,127110047,11,9,'+81');
INSERT INTO country VALUES (12,'Іспанія',504645,'1714-08-9','Monarhiya','Євро','Філіп VI','Педро Санчес',45200737,12,3,'+34');
INSERT INTO country VALUES (13,'Франція',551595,'874-02-2','Respublica','Євро','Еммануель Макрон','Едуар Філіпп',66842134,13,1,'+33');
INSERT INTO country VALUES (14,'Німеччина',357386,'1918-04-11','Monarhiya','Євро','Франк-Вальтер Штайнмаєр','Ангела Меркель',2887000,14,18,'+49');
INSERT INTO country VALUES (15,'Бразилія',8515767,'1825-8-29','Respublica','Реал','Жаїр Болсонару','Амілтон Моуран',210147125,15,19,'+55');
INSERT INTO country VALUES (16,'Канада',9984670,'1867-7-1','Monarhiya','Канадський долар','Єлизавета II','Джастін Трюдо',37067011,16,16,'+1');
INSERT INTO country VALUES (17,'Аргентина',2766890,'1810-5-25','Respublica','Аргентинський песо','Маурісіо Макрі','Габріела Мікетті',40117096,17,19,'+54');
...
INSERT INTO economy (id_economy,  VVP, Cost_of_army, Cost_of_education, Cost_of_medicine, Price_export, Price_import,year,country_id_country) VALUES (17,13000,10,50,100,300,450,2000,16);
